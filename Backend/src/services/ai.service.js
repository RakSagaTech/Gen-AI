...
const interviewReportSchema = z.object({
  ...
  })).describe("Technical questions that can be asked in the interview along wih their intention and how to answer them"),
  behavioralQuestions: z.array(z.object({
    question: z.string().describe("The technical question can be asked in the interview"),
    intention: z.string().describe("The intention of interviewer behind asking this question"),
    answer: z.string().describe("How to answer this questions, what point to cover, what approach to take etc.")
  })).describe("Behavioral questions that can be asked in the interview along wih their intention and how to answer them"),
  skillGaps: z.array(z.object({
    skills: z.string().describe("The skill which the canditate is lacking"),
...
async function generateInterviewReport({resume, selfDescription, jobDescription}){
  ...
  try{
    const prompt = `You are a senior technical interviewer and career coach.
                    ...
                    Analyze the candidate profile and the job description.
